...
print(LICENSE)
print('Datasets will be downloaded and extracted to /home/user/HDD_Data/YouTube, /home/user/HDD_Data/YouTube2018, /home/user/HDD_Data/static, /home/user/HDD_Data/DAVIS')
...
# Static data
os.makedirs('/home/user/HDD_Data/static', exist_ok=True)
print('Downloading static datasets...')
gdown.download('https://drive.google.com/uc?id=1wUJq3HcLdN-z1t4CsUhjeZ9BVDb9YKLd', output='/home/user/HDD_Data/static_data.zip', quiet=False)
print('Extracting static datasets...')
with zipfile.ZipFile('/home/user/HDD_Data/static/static_data.zip', 'r') as zip_file:
    zip_file.extractall('/home/user/HDD_Data/static/')
print('Cleaning up static datasets...')
os.remove('/home/user/HDD_Data/static/static_data.zip')
...
# YouTubeVOS
# os.makedirs('/home/user/HDD_Data/YouTube19', exist_ok=True)
# os.makedirs('/home/user/HDD_Data/YouTube/all_frames', exist_ok=True)

# print('Downloading YouTubeVOS train...')
# gdown.download('https://drive.google.com/uc?id=13Eqw0gVK-AO5B-cqvJ203mZ2vzWck9s4', output='/home/user/HDD_Data/YouTube/train.zip', quiet=False)
# print('Downloading YouTubeVOS val...')
# gdown.download('https://drive.google.com/uc?id=1o586Wjya-f2ohxYf9C1RlRH-gkrzGS8t', output='/home/user/HDD_Data/YouTube/valid.zip', quiet=False)
# print('Downloading YouTubeVOS all frames valid...')
# gdown.download('https://drive.google.com/uc?id=1rWQzZcMskgpEQOZdJPJ7eTmLCBEIIpEN', output='/home/user/HDD_Data/YouTube/all_frames/valid.zip', quiet=False)

# print('Extracting YouTube datasets...')
# with zipfile.ZipFile('/home/user/HDD_Data/YouTube19/train.zip', 'r') as zip_file:
#     zip_file.extractall('/home/user/HDD_Data/YouTube19/')
# with zipfile.ZipFile('/home/user/HDD_Data/YouTube19/valid.zip', 'r') as zip_file:
#     zip_file.extractall('/home/user/HDD_Data/YouTube19/')
# with zipfile.ZipFile('/home/user/HDD_Data/YouTube19/all_frames/valid_all_frames.zip', 'r') as zip_file:
#     zip_file.extractall('/home/user/HDD_Data/YouTube19/all_frames')

# print('Cleaning up YouTubeVOS datasets...')
# os.remove('/home/user/HDD_Data/YouTube/train.zip')
# os.remove('/home/user/HDD_Data/YouTube/valid.zip')
# os.remove('/home/user/HDD_Data/YouTube/all_frames/valid.zip')

# print('Resizing YouTubeVOS to 480p...')
# resize_youtube.resize_all('/home/user/HDD_Data/YouTube19/train', '/home/user/HDD_Data/YouTube19/train_480p')

# # YouTubeVOS 2018
# os.makedirs('/home/user/HDD_Data/YouTube2018', exist_ok=True)
# os.makedirs('/home/user/HDD_Data/YouTube2018/all_frames', exist_ok=True)

# print('Downloading YouTubeVOS2018 val...')
# gdown.download('https://drive.google.com/uc?id=1-QrceIl5sUNTKz7Iq0UsWC6NLZq7girr', output='/home/user/HDD_Data/YouTube2018/valid.zip', quiet=False)
# print('Downloading YouTubeVOS2018 all frames valid...')
# gdown.download('https://drive.google.com/uc?id=1yVoHM6zgdcL348cFpolFcEl4IC1gorbV', output='/home/user/HDD_Data/YouTube2018/all_frames/valid.zip', quiet=False)

# print('Extracting YouTube2018 datasets...')
# with zipfile.ZipFile('/home/user/HDD_Data/YouTube2018/valid.zip', 'r') as zip_file:
#     zip_file.extractall('/home/user/HDD_Data/YouTube2018/')
# with zipfile.ZipFile('/home/user/HDD_Data/YouTube2018/all_frames/valid.zip', 'r') as zip_file:
#     zip_file.extractall('/home/user/HDD_Data/YouTube2018/all_frames')

# print('Cleaning up YouTubeVOS2018 datasets...')
# os.remove('/home/user/HDD_Data/YouTube2018/valid.zip')
# os.remove('/home/user/HDD_Data/YouTube2018/all_frames/valid.zip')
