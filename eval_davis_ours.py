...
from inference_core import InferenceCore, InferenceCore_ViT
...
vit_model = models_vit.__dict__['vit_base_patch16'](
                    ...
                    global_pool=True,
                    single_object = False)
checkpoint = torch.load('/home/user/Projects/STCN/saves/May08_00.09.56_retrain_s03/May08_00.09.56_retrain_s03_150000.pth', map_location='cpu')
...
for data in progressbar(test_loader, max_value=len(test_loader), redirect_stdout=True):
    ...
    with torch.cuda.amp.autocast(enabled=args.amp):   # per sequence here 
        ...
        processor = InferenceCore_ViT(vit_model, rgb, k)
