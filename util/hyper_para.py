...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--use_pos_emd', default=True)
        parser.add_argument('--layer_index', help='the selected layer for global attention', type=int, default=4)
        # parameters for SWEM
        parser.add_argument('--valdim', help='feat. dim for ViT', type=int, default=768) 
        parser.add_argument('--num_iters', help='iterations of SWEM', type=int, default=4)
        parser.add_argument('--num_bases', help='num of bases', type=int, default=512) # 256 before
        parser.add_argument('--tau', help='tau used in softmax', type=float, default=5) #0.05
        parser.add_argument('--use_window_partition', default=False)
        parser.add_argument('--use_token_learner', default=True)

        parser.add_argument('--backbone_type', help='backbone_type', default='vit_base')
        parser.add_argument('--drop_path_rate', help='drop_path_rate', default=0.1, type=float)

        # parameters for tokenlearner
        parser.add_argument('--num_bases_foreground', help='num of bases', type=int, default=384) #256
        parser.add_argument('--num_bases_background', help='num of bases', type=int, default=384) #256
